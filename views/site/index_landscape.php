...
<div class="v2-detail">
    ...
    <div class="v2-content-detail">
        <div class="v2-top-content-detail">
            <div class="tivi-template-left">
                <div class="tivi-video">
                    <video width="400" autoplay loop>
                        <source src="/video/ds14_cake_m.mp4" type="video/mp4">
                    </video>
                </div>
            </div>
            <div class="v2-text-top-content-detail">
            ...
            <div id="polyglotLanguageSwitcher">
                <form action="">
                    <select id="polyglot-language-options">
                        <option id="v2-l" value="" selected>Landscape</option>
                        <option id="v2-p" value="">Portrait</option>
                    </select>
                </form>
            </div>
        </div>
    ...
    <div class="v2-padding-content">
        ...
        <div class="v2-btn-l-p">
            ...
            <div class="v2-choose-l-p">
                <div class="v2-btn-l"><a href="/plaza?resolution=1" class="active">Landscape Temp</a></div>
                <div class="v2-btn-p"><a href="/plaza?resolution=2" class="load_portrait">Portrait Temp</a></div>
            </div>
        </div>
    </div>
