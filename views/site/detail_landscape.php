        ...
        <div class="box-v2-top-dtl">
            <div class="v2-left-detail-l">
                <div class="box-v2-view-tpel">
                    <div class="view-template-edit-landscape">
                    ...
                    <div class="description-template-landscape">
                        <div class="pager-slide">
                            ...
                            foreach ($files as $file){
                                if($file!="."&&$file!=".."&&strtolower(substr($file, -3))=="jpg"){                                    
                                    ?>
                                <li>
                                    <a data-slide-index="<?= LayoutService::getMediumVideo($upload_template_folder, $upload_template_url, $template_path, $file) ?>" href="javascript:void(0);" onmouseover="changeValueVideoPopup('<?= LayoutService::getSmallVideo($upload_template_folder, $upload_template_url, $template_path, $file) ?>');" class="thumb-detail ajax-waiting" id="thumb-detail1<?php echo $index++;?>">
                            ...
                            ?>
                                <li>
                                    <div class="v2-col-md-3 v2-col-sm-3 v2-col-xs-3">
                                        <div class="hover-cart-landscape-detail" id="show-video<?= "-" . $model['template_id'] ?>">
